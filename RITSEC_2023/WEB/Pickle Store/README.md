...
If we take the cookie value defined in the event handler of the "Sweet Pickle" button, decode it and unpickle the inner pickled object, we'll understand better how all this works.
